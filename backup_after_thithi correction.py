...
def sunmoon():
    ...
    vara,rahu_kalam_result=trikalam(jd,place,'rahu')
    yamakandam=trikalam(jd,place,'yamaganda')
    gulika=trikalam(jd,place,'gulika')
    amrit=trikalam(jd,place,'amrit')
    durmurtham=sdurmuhurtam(jd,place)
    disha_shool_result=disha_shool(jd)
    ...
    nakshatra_result=snakshatra(jd,place)
    ...
    result={
        ...
        'rahukalam':rahu_kalam_result,
        'yamakanda_kala':yamakandam,
        'gulika_kalam':gulika,
        'amrit_kalam':amrit,
        'dhurmurtham':durmurtham,
        'disha_shool':disha_shool_result,
